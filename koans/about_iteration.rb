...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject starts with one parameter that is used to perform the action of the block
    # with the first element of the array, it then updates that parameter
    # to be used on the next element of the array
  end
  ...
  #   # code to read 'file'
  # because we do not know how long we should do the code 
  #
