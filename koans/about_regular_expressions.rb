...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # because they are bound by?, they match as many characters as possible
  ...
  # a character class is a class, alternation uses strings.
  #   however, this is a misleading question, as you can use alternation with character classes.. 
